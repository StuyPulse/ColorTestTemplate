...
public class Robot extends TimedRobot {
  ...
  public void robotPeriodic() {
    ...
    SmartDashboard.putNumber("Raw Red", detectedRawColor.red);
    SmartDashboard.putNumber("Raw Green", detectedRawColor.green);
    SmartDashboard.putNumber("Raw Blue", detectedRawColor.blue);
